...
/**
 * Class PyConvertersTest
 * @package Truelab\KottiSecurityBundle\Tests\Util
 */
class PyConvertersTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->converter = new PyConverter();
    }

    public function testChr()
    {
        $fixture = $this->providePyChrFixture();
     ...
     */
    public function testChrRaiseExceptionIfAsciiValueIsNotInRange()
    {
        $this->converter->chr(-1);
    }

    /**
     * @expectedException \Truelab\KottiSecurityBundle\Util\PyConverter\Exception\ChrValueErrorException
     */
    public function testChrRaiseExceptionIfAsciiValueIsNotInRange2()
    {
        $this->converter->chr(256);
    }

    protected function providePyChrFixture()
    {
       return
           ['\x00',
            '\x01',
